...
class RefreshTokenViewTestCase(APITestCase):
    ...
    def test_When_GetMethodForRefresh_Should_ErrorWithStatus405(self):
    ...
    def test_When_PutMethodForRefresh_Should_ErrorWithStatus405(self):
    ...
    def test_When_PatchMethodForRefresh_Should_ErrorWithStatus405(self):
    ...
    def test_When_DeleteMethodForRefresh_Should_ErrorWithStatus405(self):
